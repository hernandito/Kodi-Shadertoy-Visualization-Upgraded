...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    float speed = 0.2;
    vec3 logoColor = vec3(1,1,1); // Orangish-yellow
    ...
    int backgroundType = 2;        // 0 = noise, 1 = black, 2 = user-defined color
    vec3 backgroundColor = vec3(0.376, 0.49, 0.722); // User-defined color (e.g., dark blue)
