...
// --- Post-processing adjustment parameters ---
#define BRIGHTNESS  -0.02 // Additive brightness, 0.0 is no change
#define CONTRAST    1.04 // Multiplicative contrast, 1.0 is no change
#define SATURATION  1.0 // Multiplicative saturation, 1.0 is no change
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  // Inlined the 'effect' function's logic to resolve the compilation error.
