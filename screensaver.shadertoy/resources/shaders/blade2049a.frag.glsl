...
#define BRIGHTNESS   1.30 // Adjust overall brightness (1.0 is neutral, >1 increases, <1 decreases)
#define CONTRAST     1.00 // Adjust contrast (1.0 is neutral, >1 increases, <1 decreases)
#define SATURATION   0.05 // Adjust color saturation (1.0 is neutral, >1 increases, <1 decreases)
...
void mainImage(out vec4 O, vec2 I)
{
    ...
    for(i = 0.0; i < 60.0; ++i) // Raymarch 30 steps
    {
        // Step forward
        z += d;
