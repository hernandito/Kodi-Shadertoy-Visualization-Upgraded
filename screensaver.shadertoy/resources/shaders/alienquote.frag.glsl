...
vec2 caret_origin = vec2(2.10, 0.865);
vec2 caret;
...
// =====================================
	...
	d += P(r()); d += R(r()); d += I(r()); d += O(r()); d += R(r()); d += I(r()); d += T(r()); d += Y(r()); _();	
	d += O(r()); d += N(r()); d += E(r()); d += STOP(r()); _();	
newline();	
...
Crew expendable.
	...
	d += O(r()); d += F(r()); _();	
newline();	
	d += O(r()); d += R(r()); d += G(r()); d += A(r()); d += N(r()); d += I(r()); d += S(r()); d += M(r()); d += STOP(r()); _();	
	d += A(r()); d += L(r()); d += L(r()); _();	
	d += O(r()); d += T(r()); d += H(r()); d += E(r()); d += R(r()); _();		
newline();	
	d += C(r()); d += O(r()); d += N(r()); d += S(r()); d += I(r()); d += D(r()); d += E(r()); d += R(r()); d += A(r()); d += T(r()); ; d += I(r()); d += O(r()); d += N(r()); ; d += S(r()); _();	
