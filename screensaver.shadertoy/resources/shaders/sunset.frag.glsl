...
#define SOFT_SUN 1
#define cloudy  0.65 //0.0 clear sky
#define haze  0.01 * (cloudy*20.)
#define rainmulti 8.0 // makes clouds thicker
...
const float I = 5.5; //sun light power, 10.0 is normal
const float SI = 5.; //sun intensity for sun
const float g = 0.25; //light concentration .76 //.45 //.6  .45 is normaL
const float g2 = g * g;
