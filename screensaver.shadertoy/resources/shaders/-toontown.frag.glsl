...
vec3 path(float ti) {
	ti*=1.5;
	vec3  p=vec3(sin(ti),(1.-sin(ti*2.))*.5,-ti*5.)*.45;
	return p;
}
...

{
	...
	float an=atan(dir.x,dir.y)+iTime*.5; // angle for drawing and rotating sun
