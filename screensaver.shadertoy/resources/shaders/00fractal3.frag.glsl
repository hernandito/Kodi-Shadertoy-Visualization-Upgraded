...
// Antialiasing level - Fixed for Kodi compatibility.
// Removed HW_PERFORMANCE check as it's not defined in Kodi.
#define AA 2 // Set to 2 for better quality, adjust to 1 if performance is an issue.
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec3 tot = vec3(0.0);
    // Loop for AA, now fixed based on the AA define
